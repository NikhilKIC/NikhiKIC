...
//this is defining the rest of the undefined variables
?>
...
<body>
  ...
  <div class="nav">
    <ul>
      ...
      <li><a href="home.php">INFO PAGE</a></li>
...
<br><br>
  ...
  <div class="boxtwo" style="border-radius: 10px; width:73.5%; height:900px; margin-left:13%;margin-top:10px;background-color:white">
    ...
    <div class="box-cnt">
      <h3 class="box-cnt-h">ALL EBOOKS</h3>
	               ...
	               {   
                      {
                        ...
                        echo "<td>" ;echo $row["b_id"]; echo "</td>"; //this presents the publication's ID
                        echo "<td>";echo "$lg1"; echo $row["booksname"]; echo "</a>"; echo "</td>"; //this will show the name of the book/ publication
                        echo "<td>"; echo $row["authorname"]; echo "</td>"; //this will present the name of the author of the publication
                        echo "<td>"; echo $row["file_name"]; echo "</td>"; //this will show name name of the file/ebook/publication 
