...
$name=$_SESSION["sname"]; //the student name (sname) is being defined as $name
$email=$_SESSION["semail"]; //the student email (semail) is being defined as $email
     ...
     <table  style =" font-size:16pt"  align="center" width="100%" height="100%">
      ...
      <div class="nav">
        <ul>
          ...
          <li><a href="home.php">INFO PAGE</a>
          </li>
