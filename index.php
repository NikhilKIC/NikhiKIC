...
//this is used to log-into the code. It checks all the created account's usernames and passwords.
//If user is trying to log in with an incorrect user or pass, it will display invalid username or password    
    
{
 ...
 //this code is used to access the admin home page.
 //if the username, and password matches the admin username and password it will allow the user to enter the admmin home page.
 //if not it will take you to the opening home page
}
...
<body>
  <div class="box">
   <table  style =" font-size:16pt"  align="center" width="100%" height="100%" >
      <tr>
        <td style="color:white"><h1 align="center"><marquee>Online Ebook System</marquee></td></h1>
      </tr>
      <tr>
        <td style="color:white" align="center"><b>LOGIN PAGE</b></td>
      </tr>
    </table>
  </div>
    <br>
